...
const TX = {
  en: {
    ...
    decisionFacing:"Decision facing:",swipeProfiles:"Tap ‹ › to see different profiles",
    ...
    writeStoryTitle:"✍️ Write Your Story",
    writeStorySub:"Describe your situation in your own words. LifeLens will create your personal Shadow Self.",
    ...
    enterCode:"🔒 Enter Access Code",privateBeta:"This app is currently in private beta.",
    enterPlaceholder:"Enter access code",enterBtn:"Enter →",wrongCode:"Incorrect code — try again",
  },
  es: {
    ...
    decisionFacing:"Decisión que enfrenta:",swipeProfiles:"Toca ‹ › para ver otros perfiles",
    ...
    assessmentSub:"Responde 6 preguntas. La IA usa datos demográficos reales para generar tu perfil de riesgo personalizado.",
    ...
    onboardingIntro:"LifeLens muestra los resultados estadísticos reales de las grandes decisiones de la vida — por raza, género y contexto. No para limitarte, sino para que elijas con información completa.",
    ...
    writeStoryTitle:"✍️ Escribe Tu Historia",
    writeStorySub:"Describe tu situación con tus propias palabras. LifeLens creará tu Sombra personal.",
    writeStoryPlaceholder:"Cuéntame qué está pasando. ¿Qué decisión enfrentas? ¿Qué te detiene? ¿Qué esperas? Escribe lo que quieras...",
    ...
    enterCode:"🔒 Ingresa el Código de Acceso",privateBeta:"Esta aplicación está en beta privada.",
    enterPlaceholder:"Ingresa el código de acceso",enterBtn:"Entrar →",wrongCode:"Código incorrecto — intenta de nuevo",
  }
};
const tx = (lang, key) => {
...
const SHADOW_PROFILES = [
  ...
  {name:"Carlos",age:19,emoji:"👨🏽",race:"Hispanic",gender:"Man",socio:"Working class",region:"Suburban",city:"San Antonio, TX",
   ...
   context:"He has a landscaping side hustle making $800/month and wants to go full-time and skip college.",
   bestCase:{label:"He formalizes the business + takes free SBA mentorship",outcomes:[{icon:"💰",text:"Grows to $65K revenue by 25 with 2 employees"},{icon:"🏥",text:"Joins a business owners' health co-op — coverage for ~$180/month"},{icon:"💞",text:"Business ownership creates pride and stability"},{icon:"⚖️",text:"LLC structure protects personal assets from day one"}],stat:"Hispanic-owned businesses are among the fastest growing in the US"},
   worstCase:{label:"He runs it informally with no structure",outcomes:[{icon:"💰",text:"Business fails within 3 years — back to square one with no degree"},{icon:"🏥",text:"Uninsured for 4+ years — avg ER visit costs $2,200"},{icon:"💞",text:"62% of founders report severe relationship strain in years 1–3"},{icon:"⚖️",text:"IRS penalties for unreported income average $1,200"}],stat:"80% of businesses that fail cite lack of planning as the primary cause"}},
  {name:"Madison",age:20,emoji:"👩🏼",race:"White",gender:"Woman",socio:"Middle class",region:"Rural",city:"Rural Kentucky",
   ...
   context:"She's been with her partner 2 years. They're talking about skipping college and starting life together now.",
   bestCase:{label:"They take pre-marital counseling + build financial foundation first",outcomes:[{icon:"💰",text:"Household income $68K by 22 — on track for home ownership by 27"},{icon:"🏥",text:"Stable marriage is one of the strongest predictors of long-term health"},{icon:"💞",text:"Couples with shared financial goals have 40% lower conflict rates"},{icon:"⚖️",text:"Low legal risk — wills set up early protect both partners"}],stat:"Couples who complete pre-marital education report 30% higher satisfaction"},
   worstCase:{label:"They marry quickly without a foundation",outcomes:[{icon:"💰",text:"45% of under-25 rural marriages end in divorce — avg cost $15,000"},{icon:"🏥",text:"Unhappy marriage is clinically worse than being single — depression doubles"},{icon:"💞",text:"First child + financial stress = top predictor of early separation"},{icon:"⚖️",text:"Custody in rural areas requires expensive legal help with limited access"}],stat:"Women who divorce before 25 take an average of 5 years to financially recover"}},
  {name:"James",age:18,emoji:"👨🏽‍🦱",race:"Indigenous",gender:"Man",socio:"Low income",region:"Rural",city:"Rural Montana",
   ...
   bestCase:{label:"He enlists, uses the GI Bill, plans his exit from day one",outcomes:[{icon:"💰",text:"$38K salary + free housing + healthcare on day one. GI Bill covers 4-year degree"},{icon:"🏥",text:"Full VA healthcare for life — one of the strongest benefits available"},{icon:"💞",text:"Military community provides structure and belonging"},{icon:"⚖️",text:"SCRA protections freeze debt interest during service"}],stat:"Veterans who use the GI Bill have 40% higher lifetime earnings"},
   worstCase:{label:"He enlists without support awareness and struggles with transition",outcomes:[{icon:"💰",text:"Veterans without a degree plan often return to low-wage work — GI Bill unused by 40%"},{icon:"🏥",text:"PTSD affects 20% of combat veterans — Indigenous veterans least likely to seek care"},{icon:"💞",text:"Military divorce rate 15% higher than civilian"},{icon:"⚖️",text:"Indigenous veterans face disproportionate barriers accessing VA benefits"}],stat:"Indigenous veterans are the most decorated per capita — and the most underserved"}},
  {name:"Priya",age:21,emoji:"👩🏽",race:"Asian",gender:"Woman",socio:"Upper middle class",region:"Urban (major city)",city:"New York, NY",
   ...
   bestCase:{label:"She defers the job offer + does a structured gap program",outcomes:[{icon:"💰",text:"Returns refreshed — gap year grads earn 8% more within 5 years"},{icon:"🏥",text:"88% of gap year alumni report significantly improved mental health"},{icon:"💞",text:"Self-awareness gained leads to healthier relationships"},{icon:"⚖️",text:"AmeriCorps and structured programs provide legal support abroad"}],stat:"90% of employers view gap year experience favorably"},
   worstCase:{label:"She quits without a plan and drifts for a year",outcomes:[{icon:"💰",text:"Loses the job offer — re-entering NYC market takes 8–14 months"},{icon:"🏥",text:"Unstructured time without purpose can worsen anxiety"},{icon:"💞",text:"Financial dependence on family strains relationships"},{icon:"⚖️",text:"Overstaying visas creates immigration complications"}],stat:"The difference between a good and bad gap year is almost entirely about structure"}},
  {name:"Jordan",age:19,emoji:"🧑🏽",race:"Multiracial / Other",gender:"Non-binary / Gender non-conforming",socio:"Working class",region:"Small city / town",city:"Albuquerque, NM",
   ...
   context:"Making $1,200/month driving for Uber and TaskRabbit. It feels like freedom.",
   bestCase:{label:"They treat gig work as a launchpad + build a high-skill niche",outcomes:[{icon:"💰",text:"Develops a specialty — freelance income reaches $55K by 25"},{icon:"🏥",text:"Qualifies for ACA subsidies — coverage under $100/month"},{icon:"💞",text:"Flexibility allows them to be present for community"},{icon:"⚖️",text:"LLC + quarterly tax filing keeps them legally protected"}],stat:"Skilled freelancers who specialize earn 3x more than general gig workers within 3 years"},
   worstCase:{label:"They stay in low-skill gig work with no growth plan",outcomes:[{icon:"💰",text:"$32K median income — below living wage in most US cities"},{icon:"🏥",text:"78% of non-binary gig workers are uninsured"},{icon:"💞",text:"Income instability is the #1 predictor of relationship breakdown"},{icon:"⚖️",text:"Accumulated IRS penalties for unfiled taxes average $3,400"}],stat:"Non-binary workers face a 32% wage gap — gig work amplifies rather than escapes it"}},
  {name:"Sofia",age:17,emoji:"👩🏽",race:"Hispanic",gender:"Woman",socio:"Low income",region:"Urban (major city)",city:"New York, NY",
   ...
   context:"Sofia was brought from Mexico at age 3. She's a DACA (Deferred Action for Childhood Arrivals) recipient and a straight-A student. Her parents work two jobs each.",
   bestCase:{label:"She applies to college and wins scholarships specifically for DACA students",outcomes:[{icon:"💰",text:"NYC has strong scholarship programs for DACA students — full funding is possible"},{icon:"🏥",text:"College counseling dramatically reduces immigrant teen anxiety and isolation"},{icon:"💞",text:"Family pride in her achievement becomes a generational turning point"},{icon:"⚖️",text:"DACA renewal + college degree = stronger foundation for future immigration pathways"}],stat:"DACA recipients who complete college are 90% more likely to stay off public assistance"},
   worstCase:{label:"She drops out and enters the informal workforce",outcomes:[{icon:"💰",text:"Without a degree, DACA recipients average $15–18/hr with no benefits in NYC"},{icon:"🏥",text:"Undocumented workers are least likely to seek healthcare — one emergency creates lasting debt"},{icon:"💞",text:"Putting family finances on her shoulders at 17 creates long-term emotional burden"},{icon:"⚖️",text:"Informal work exposes her to wage theft with little legal recourse"}],stat:"First-generation college graduates are 5x more likely to lift their entire family out of poverty within 10 years"}},
  {name:"Diego",age:18,emoji:"👨🏽",race:"Hispanic",gender:"Man",socio:"Working class",region:"Urban (major city)",city:"Miami, FL",
   decision:"Stay in the US for college vs. accept a full scholarship at a university in Colombia",
   ...
   bestCase:{label:"He takes the scholarship, graduates debt-free, and returns to the US with a degree",outcomes:[{icon:"💰",text:"Graduates debt-free with an engineering degree — $0 loans vs. avg $37K US student debt"},{icon:"🏥",text:"Colombian university healthcare is fully covered — no medical debt risk"},{icon:"💞",text:"Reconnects with extended family roots — strengthens identity and belonging"},{icon:"⚖️",text:"US citizen studying abroad retains all citizenship rights"}],stat:"International engineering graduates who return to the US earn the same as domestic grads within 3 years — with zero debt"},
   worstCase:{label:"He stays, takes loans, and struggles without full support",outcomes:[{icon:"💰",text:"$37K average student debt — first-gen Latino men default at 2x the rate of white peers"},{icon:"🏥",text:"Financial stress is the #1 cause of dropout among first-generation Latino men"},{icon:"💞",text:"Distance from culture without community buffer — isolation is a real academic risk"},{icon:"⚖️",text:"Student debt follows him for 20+ years"}],stat:"Only 16% of first-gen Latino men complete a 4-year degree within 6 years — but 58% complete with full financial support"}},
  {name:"Zoe",age:16,emoji:"👩🏻",race:"White",gender:"Woman",socio:"Middle class",region:"Rural",city:"Rural Tennessee",
   ...
   bestCase:{label:"She builds a support network first and times her disclosure carefully",outcomes:[{icon:"💰",text:"Teens who come out with support networks are 40% less likely to experience housing instability"},{icon:"🏥",text:"Living authentically reduces depression by up to 50%"},{icon:"💞",text:"The right counselor can mediate family conversations — many religious families come around over time"},{icon:"⚖️",text:"LGBTQ+ youth organizations can help her build a legal safety net before disclosure"}],stat:"LGBTQ+ youth with at least ONE supportive adult are 40% less likely to attempt suicide"},
   worstCase:{label:"She comes out without support and faces family rejection",outcomes:[{icon:"💰",text:"40% of homeless youth identify as LGBTQ+ — family rejection is the primary cause"},{icon:"🏥",text:"LGBTQ+ youth rejected by family are 8x more likely to attempt suicide"},{icon:"💞",text:"Forced disclosure without support can permanently damage relationships that might otherwise heal"},{icon:"⚖️",text:"As a minor in a conservative state, she has limited legal recourse if family controls her housing"}],stat:"Accepted LGBTQ+ youth are 3x more likely to graduate high school and 5x more likely to report high life satisfaction at 25"}},
  {name:"Andre",age:18,emoji:"👨🏿",race:"Black",gender:"Man",socio:"Working class",region:"Urban (major city)",city:"Atlanta, GA",
   ...
   context:"Andre just graduated high school and is deeply embedded in a Black church community where his family has deep roots. Being gay is known but never spoken.",
   bestCase:{label:"He builds a chosen family of affirming community before coming out",outcomes:[{icon:"💰",text:"Atlanta has one of the strongest Black LGBTQ+ professional networks in the US"},{icon:"🏥",text:"Living openly with community support dramatically reduces depression and hypertension in Black gay men"},{icon:"💞",text:"Many Black families, even religious ones, ultimately prioritize love — 60% come around within 3 years"},{icon:"⚖️",text:"Knowing his rights protects him in housing and employment in a state with limited protections"}],stat:"Black LGBTQ+ adults with affirming community are 4x more likely to report excellent mental health"},
   worstCase:{label:"He loses community and family support without a safety net",outcomes:[{icon:"💰",text:"Loss of church and family network means loss of job referrals, housing support, and social capital"},{icon:"🏥",text:"Black gay men face the highest rates of depression of any demographic — isolation dramatically worsens this"},{icon:"💞",text:"Church and community are often the primary mental health infrastructure for Black families"},{icon:"⚖️",text:"Without family support he is more vulnerable to housing instability"}],stat:"Black LGBTQ+ youth who lose family support are 3x more likely to experience homelessness within 12 months"}},
  {name:"Destiny",age:18,emoji:"👩🏾",race:"Black",gender:"Woman",socio:"Low income",region:"Urban (major city)",city:"Detroit, MI",
   ...
   bestCase:{label:"She enrolls in extended care AND uses every transitional resource available",outcomes:[{icon:"💰",text:"Michigan extended care: housing + $600/month stipend until 21, plus free tuition at any state community college"},{icon:"🏥",text:"Medicaid coverage until age 26 — one of the most valuable benefits for young adults without family"},{icon:"💞",text:"Transitional programs connect her with mentors and peer community"},{icon:"⚖️",text:"Extended care gives her time to build credit and understand tenant rights"}],stat:"Foster youth who use extended care have 3x higher college enrollment and 50% lower homelessness rates"},
   worstCase:{label:"She ages out without using extended benefits",outcomes:[{icon:"💰",text:"Over 50% of youth who age out experience homelessness within 2 years"},{icon:"🏥",text:"Former foster youth without support have the highest rates of untreated mental health conditions"},{icon:"💞",text:"Without family or community, loneliness becomes the dominant experience"},{icon:"⚖️",text:"Unaware of her rights, she is vulnerable to illegal evictions and benefit gaps"}],stat:"By age 26, only 3% of foster care alumni have completed a college degree — extended care doubles that rate"}},
  {name:"Tyler",age:17,emoji:"👦🏼",race:"White",gender:"Man",socio:"Low income",region:"Suburban",city:"Phoenix, AZ",
   ...
   context:"Tyler has been in foster care since age 9. His father just completed a 5-year sentence and wants a relationship. The group home is stable but lonely.",
   bestCase:{label:"He builds a relationship with his father slowly while staying in stable housing",outcomes:[{icon:"💰",text:"Maintaining stable housing through 18 gives him access to Arizona's extended foster care benefits"},{icon:"🏥",text:"Gradual family reunion with counseling has 60% positive outcomes — rushed reunion has less than 30%"},{icon:"💞",text:"A father who earns trust over time is more valuable than one who feels obligated under one roof"},{icon:"⚖️",text:"Staying in care keeps his caseworker and legal protections in place"}],stat:"Youth who maintain stable housing through age 18 are 2x more likely to complete education"},
   worstCase:{label:"He moves in immediately and the home becomes unstable",outcomes:[{icon:"💰",text:"If the placement fails, re-entering foster care at 17 is extremely difficult"},{icon:"🏥",text:"Retraumatization from a failed reunion is one of the most damaging experiences for foster youth"},{icon:"💞",text:"A failed reunion can permanently damage a relationship that might have thrived with slower development"},{icon:"⚖️",text:"Living with a parent on parole can create unintended legal complications"}],stat:"65% of rapid post-incarceration family reunifications with minors disrupt within 12 months"}},
  {name:"Aaliyah",age:18,emoji:"👩🏾‍🦱",race:"Black",gender:"Woman",socio:"Working class",region:"Urban (major city)",city:"Houston, TX",
   decision:"Accept her full Division I volleyball scholarship vs. pursue pre-medicine",
   context:"Aaliyah has a full athletic scholarship to a Division I (highest level of college athletics) program. She is burning out and secretly wants to study medicine.",
   bestCase:{label:"She has an honest conversation with her coach and negotiates a balance",outcomes:[{icon:"💰",text:"A full scholarship IS pre-med funding — many Division I athletes successfully complete pre-med"},{icon:"🏥",text:"Athletes who pursue both passion and academics report significantly better mental health"},{icon:"💞",text:"Honest communication with family builds trust — her parents want her success, not just her sacrifice"},{icon:"⚖️",text:"NCAA (National Collegiate Athletic Association) rules allow academic flexibility she may not know she has"}],stat:"Black women who complete STEM degrees earn 40% more over their lifetime than any other path"},
   worstCase:{label:"She accepts without honesty, burns out, and loses both paths",outcomes:[{icon:"💰",text:"If she burns out and loses the scholarship, she loses $200K+ in funding with no backup plan"},{icon:"🏥",text:"Athletic burnout combined with suppressed career dreams is a documented path to depression"},{icon:"💞",text:"Silently sacrificing for family creates resentment that damages relationships"},{icon:"⚖️",text:"Injury during a sport she doesn't love, without academic planning, leaves her with neither career nor compensation"}],stat:"Less than 2% of college athletes go pro — but 100% of them can apply to medical school"}},
  {name:"Jaylen",age:17,emoji:"👦🏿",race:"Black",gender:"Man",socio:"Low income",region:"Urban (major city)",city:"Chicago, IL",
   decision:"Pursue professional soccer after high school vs. accept his full college scholarship",
   context:"Jaylen has been scouted by an MLS (Major League Soccer) development team. He also has a full academic scholarship to a Division II school. His family is counting on him.",
   bestCase:{label:"He goes to college, dominates the game, and enters the MLS Draft in 4 years",outcomes:[{icon:"💰",text:"College soccer players who enter the MLS Draft have 3x the contract negotiating power"},{icon:"🏥",text:"4 more years of physical development make him a stronger, less injury-prone professional"},{icon:"💞",text:"College gives him a backup degree and a life identity beyond the sport"},{icon:"⚖️",text:"Scholarship protects his family financially while he develops"}],stat:"NCAA college soccer players who enter MLS earn 40% higher starting contracts than direct youth signings"},
   worstCase:{label:"He signs with the development team, gets injured, and has no degree",outcomes:[{icon:"💰",text:"MLS development contracts average $18–25K/year — below poverty line"},{icon:"🏥",text:"Lower-level players receive minimal medical support — one injury can end a career"},{icon:"💞",text:"Family financial pressure multiplies if he isn't producing income"},{icon:"⚖️",text:"Many young athletes sign unfavorable contracts without understanding the terms"}],stat:"The average professional soccer career lasts 8 years — but only 1.7% of high school players ever play professionally"},
  },
];
...
const SCENARIOS = [
  ...
  {id:"substances",category:"lifestyle",icon:"⚠️",riskScore:78,title:"Regular Substance Use",tagline:"Regular use of cannabis, alcohol, or other substances",
   outcomes:{
     ...
     relationship:{headline:"3x higher breakup/divorce rate",stat:"Addiction cited in 50% of divorces nationally",byRace:{"All groups":"Similar"},byGender:{"Man":"Partner more often affected","Woman":"Linked to elevated DV risk","Non-binary / Gender non-conforming":"High risk"}},
  ...
  {id:"mental_health",category:"identity",icon:"🧠",riskScore:40,title:"Seeking Mental Health Treatment",tagline:"Getting therapy, counseling, or psychiatric care",
   outcomes:{
     ...
     legal:{headline:"Very low legal risk — HIPAA (Health Insurance Portability and Accountability Act) protects your privacy",stat:"Mental health records are among the most legally protected in the US",byRace:{"All groups":"Similar"},byGender:{"All groups":"Very low"}},
   },
   beatsOdds:["School counselors can connect you to free or sliding-scale care","Community mental health centers offer care regardless of ability to pay","Teletherapy has made access dramatically easier"],
  ...
  {id:"social_media",category:"identity",icon:"📲",riskScore:48,title:"Social Media as Identity",tagline:"When online life becomes your primary world",
   outcomes:{
     ...
     legal:{headline:"Content creators face copyright, defamation, and privacy risks",stat:"FTC (Federal Trade Commission) requires disclosure of paid partnerships",byRace:{"All groups":"Similar"},byGender:{"Woman":"Higher risk of non-consensual image sharing"}},
   },
  ...
  {id:"immigration",category:"identity",icon:"🌎",riskScore:68,title:"Navigating Undocumented Status",tagline:"Living and planning your future without documentation",
   outcomes:{
...
function PasswordGate({onUnlock, lang}) {
    ...
    <div style={{background:C.bg,minHeight:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:20}}>
      ...
      <div style={{background:C.card,border:`1px solid ${error?"#ef4444":C.border}`,borderRadius:18,padding:28,maxWidth:380,width:"100%",textAlign:"center",transition:"border-color 0.3s"}}>
        ...
        <div style={{display:"flex",gap:8,justifyContent:"center",marginTop:16}}>
          <button onClick={()=>window.__setLang&&window.__setLang("en")} style={{background:"#1e2130",border:"none",borderRadius:20,padding:"5px 14px",color:"white",fontSize:12,cursor:"pointer"}}>🇺🇸 EN</button>
          <button onClick={()=>window.__setLang&&window.__setLang("es")} style={{background:"#1e2130",border:"none",borderRadius:20,padding:"5px 14px",color:"white",fontSize:12,cursor:"pointer"}}>🇪🇸 ES</button>
        </div>
      </div>
    </div>
  );
  ...
  return(
    <div style={{marginBottom:24}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div>
          <div style={{fontSize:15,fontWeight:800,color:"#a78bfa"}}>{tx(lang,"shadowSelf")}</div>
      ...
      <div style={{background:"linear-gradient(135deg,#1a1040,#161923)",border:"1px solid #2d2060",borderRadius:16,padding:18,marginBottom:12}}>
        ...
        <div style={{fontSize:13,color:"#94a3b8",lineHeight:1.6,background:"rgba(0,0,0,0.2)",borderRadius:10,padding:"10px 12px"}}>
          <span style={{fontWeight:700,color:"#a78bfa"}}>{tx(lang,"decisionFacing")} </span>{p.decision}<br/>
      ...
      <div style={{textAlign:"center",fontSize:11,color:"#374151",marginTop:6}}>{tx(lang,"swipeProfiles")}</div>
    </div>
  );
}
...
function WriteYourStory({profile,lang="en"}){
  ...
  const generate=async()=>{
    ...
    try{
      const prompt=`You are LifeLens, created by Ms. Rosa Chavez — a veteran NYC teacher who has devoted her life to helping teenagers make better decisions. Write with her warmth, directness, and deep care.

A teenager has shared their story. Create a Shadow Self analysis in this EXACT JSON format (respond ONLY with JSON — no markdown, no backticks, no explanation):
{
  "name": "${name||"You"}",
  "decision": "one clear sentence summarizing their core decision",
  "context": "2 warm, non-judgmental sentences about their situation that make them feel seen",
  "bestCase": {
    "label": "best path forward — one short phrase",
    "outcomes": [
      {"icon": "💰", "text": "specific financial outcome with a real statistic relevant to their profile"},
  ...
  "worstCase": {
    "label": "worst path — one short phrase",
    "outcomes": [
      {"icon": "💰", "text": "specific financial risk with a statistic"},
    ...
    "stat": "one sobering but true statistic"
  },
  "message": "One warm, powerful sentence in Ms. Chavez's voice — like a note she would leave on a teenager's desk. Start it with 'Remember:' or 'Dear ${name||"you"},'"
}
  ...
  if(result&&!error){
    return(
      <div style={{paddingBottom:80}}>
        <div style={{background:"linear-gradient(135deg,#1a1040,#161923)",border:"1px solid #2d2060",borderRadius:16,padding:20,marginBottom:16,textAlign:"center"}}>
          <div style={{fontSize:36,marginBottom:8}}>🪞</div>
          <div style={{fontSize:18,fontWeight:900,color:C.accentLight,marginBottom:4}}>{tx(lang,"yourShadowSelf")}</div>
          <div style={{fontSize:14,color:"#7c3aed"}}>{result.name}</div>
        </div>
        <div style={{background:C.card,border:"1px solid #2d2060",borderRadius:14,padding:16,marginBottom:12}}>
          <div style={{fontSize:13,fontWeight:700,color:"#a78bfa",marginBottom:6}}>Your Decision</div>
        ...
        {result.message&&(
          <div style={{background:"linear-gradient(135deg,#0d1f3c,#161923)",border:"1px solid #1e3a5f",borderRadius:14,padding:18,marginBottom:14}}>
            <div style={{fontSize:12,color:"#60a5fa",fontWeight:700,marginBottom:8,textTransform:"uppercase",letterSpacing:0.8}}>{tx(lang,"messageFrom")}</div>
            <div style={{fontSize:15,color:"#e2e8f0",lineHeight:1.7,fontStyle:"italic"}}>"{result.message}"</div>
            <div style={{fontSize:12,color:"#374151",marginTop:10}}>— Ms. Chavez, LifeLens</div>
          </div>
        )}
        <button onClick={()=>{setResult(null);setStory("");setName("");}} style={{width:"100%",background:C.card,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px",color:C.muted,fontSize:14,cursor:"pointer",minHeight:50}}>{tx(lang,"tryAgain")}</button>
      </div>
    );
  }
  ...
  return(
    <div style={{paddingBottom:80}}>
      <div style={{background:"linear-gradient(135deg,#1a1040,#161923)",border:"1px solid #2d2060",borderRadius:16,padding:20,marginBottom:16,textAlign:"center"}}>
        ...
        <div style={{fontSize:16,fontWeight:800,color:C.accentLight,marginBottom:8}}>{tx(lang,"writeStoryTitle")}</div>
        <div style={{fontSize:13,color:"#94a3b8",lineHeight:1.7}}>{tx(lang,"writeStorySub")}</div>
      </div>
      <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:16,padding:18,marginBottom:12}}>
        ...
        <input value={name} onChange={e=>setName(e.target.value)} placeholder={tx(lang,"namePlaceholder")} style={{width:"100%",background:C.bg,border:`1px solid ${C.border}`,borderRadius:10,padding:"12px 14px",color:C.text,fontSize:15,outline:"none",boxSizing:"border-box",marginBottom:16}}/>
        <div style={{fontSize:13,color:C.muted,marginBottom:6}}>Your story</div>
        <textarea value={story} onChange={e=>setStory(e.target.value)} placeholder={tx(lang,"writeStoryPlaceholder")} style={{width:"100%",background:C.bg,border:`1px solid ${C.border}`,borderRadius:10,padding:"14px",color:C.text,fontSize:14,minHeight:160,resize:"vertical",outline:"none",boxSizing:"border-box",fontFamily:"inherit",lineHeight:1.6}}/>
        {error&&<div style={{color:"#f87171",fontSize:13,marginTop:8}}>Something went wrong. Please try again.</div>}
        <button onClick={generate} disabled={!story.trim()||loading} style={{marginTop:14,width:"100%",background:story.trim()&&!loading?"linear-gradient(135deg,#4f46e5,#7c3aed)":"#1e2130",border:"none",borderRadius:12,padding:"16px",color:story.trim()&&!loading?"white":"#374151",fontSize:15,fontWeight:700,cursor:story.trim()&&!loading?"pointer":"not-allowed",minHeight:52}}>
...
function JournalTab({saved,onUnsave,lang="en"}){
  const savedScenarios=SCENARIOS.filter(s=>saved.includes(s.id));
  return(
    <div style={{paddingBottom:80}}>
      <ShadowSelf lang={lang}/>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
      ...
      {savedScenarios.length===0
        ?<div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:14,padding:24,textAlign:"center"}}>
          ...
          <div style={{color:C.muted,fontSize:14,lineHeight:1.6}}>{tx(lang,"noSaved")}<br/>{tx(lang,"tapSave")}</div>
        </div>
    ...
    <div style={{paddingBottom:80}}>
      ...
      {saved.length===0&&(
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:14,padding:24,textAlign:"center",marginBottom:16}}>
          ...
          <div style={{color:C.muted,fontSize:14,lineHeight:1.6}}>Your Life Map is empty.<br/>Save scenarios in <strong style={{color:C.accentLight}}>Scenarios</strong> to build your map.</div>
        </div>
      )}
              ...
              {catScenarios.map(sc=>{
                ...
                return(
                  <div key={sc.id} style={{background:isSaved?C.card:"#0c0f1a",border:`1px solid ${isSaved?color:C.border}`,borderRadius:12,padding:12,opacity:isSaved?1:0.35,transition:"all 0.2s"}}>
                    ...
                    <div style={{fontSize:10,color:isSaved?color:"#374151",fontWeight:700}}>{isSaved?label:tx(lang,"notExplored")}</div>
                  </div>
                );
              })}
            </div>
...
function ScenarioExplorer({profile,saved,onSave,lang="en"}){
  ...
  if(selected){
    const sc=selected;
    const{label,color,sentence}=getRiskLevel(sc.riskScore);
    ...
    return(
      <div style={{paddingBottom:80}}>
        ...
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:16,padding:18,marginBottom:12}}>
          ...
          <h2 style={{color:C.text,fontSize:20,fontWeight:800,margin:"0 0 4px"}}>{sc.title}</h2>
          <div style={{color:"#e2e8f0",fontSize:13,fontWeight:700,marginBottom:14}}>{sc.tagline}</div>
          ...
          <div style={{fontSize:13,color:"#94a3b8",lineHeight:1.5,fontStyle:"italic",marginBottom:12}}>{sentence}</div>
        ...
        {OUTCOME_TYPES.map(t=>{
          const outcome=sc.outcomes[t.id];
          ...
          return(
            <div key={t.id} style={{background:"#0c0f1a",border:`1px solid ${C.border}`,borderRadius:12,padding:14,marginBottom:10}}>
              ...
              {showDemo&&(rV||gV)&&(
                <div style={{background:C.card,borderLeft:`3px solid ${t.color}`,borderRadius:"0 8px 8px 0",padding:"9px 11px"}}>
                  <div style={{fontSize:10,color:"#475569",marginBottom:5,textTransform:"uppercase",letterSpacing:0.8}}>{tx(lang,"yourProfile")}</div>
        ...
        <div style={{background:"linear-gradient(135deg,#0d1f3c,#161923)",border:"1px solid #1e3a5f",borderRadius:14,padding:18,marginBottom:12}}>
          <div style={{fontSize:15,fontWeight:700,color:"#60a5fa",marginBottom:12}}>{tx(lang,"pathsBeatOdds")}</div>
        ...
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:14,padding:18,marginBottom:14}}>
          <div style={{fontSize:15,fontWeight:700,color:"#a78bfa",marginBottom:12}}>{tx(lang,"resources")}</div>
          {sc.resources.map((r,i)=>(
            <a key={i} href={r.url} target="_blank" rel="noopener noreferrer" style={{display:"flex",gap:12,alignItems:"flex-start",background:"#0c0f1a",border:`1px solid ${C.border}`,borderRadius:12,padding:14,marginBottom:8,textDecoration:"none"}}>
              <span style={{fontSize:22,flexShrink:0}}>{r.emoji}</span>
              <div>
                <div style={{fontSize:14,fontWeight:700,color:"#60a5fa",marginBottom:3}}>{r.label} ↗</div>
        ...
        <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
          <span style={{fontSize:11,color:"#2d3348"}}>{tx(lang,"sources")}</span>
          {sc.sources.map((s,i)=><span key={i} style={{fontSize:11,color:"#2d3348",background:C.card,padding:"3px 9px",borderRadius:8}}>{s}</span>)}
        </div>
      </div>
    );
  }
          ...
          return(
            <div key={sc.id} onClick={()=>setSelected(sc)} style={{background:C.card,border:`1px solid ${isSaved?color:C.border}`,borderRadius:16,padding:18,cursor:"pointer"}}>
              ...
              <div style={{marginTop:10,display:"flex",alignItems:"center"}}>
                ...
                <span style={{marginLeft:"auto",fontSize:12,color:"#2d3348"}}>{tx(lang,"tapExplore")}</span>
              </div>
            </div>
          );
        })}
...
Tone: direct, non-judgmental, empowering. Never preachy.`;
  ...
  if(step===0)return(
    <div style={{textAlign:"center",padding:"40px 16px",paddingBottom:80}}>
      ...
      <p style={{color:C.muted,fontSize:14,lineHeight:1.7,marginBottom:28,maxWidth:340,margin:"0 auto 28px"}}>{tx(lang,"assessmentSub")}</p>
      <button onClick={()=>setStep(1)} style={{background:"linear-gradient(135deg,#4f46e5,#7c3aed)",border:"none",borderRadius:14,padding:"16px 36px",color:"white",fontSize:16,fontWeight:700,cursor:"pointer",minHeight:52}}>{tx(lang,"startAssessment")}</button>
    </div>
  );
      ...
      <div style={{paddingBottom:80}}>
        ...
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:16,padding:20}}>
          ...
          {q.type==="text"
            ...
            :q.options.map(opt=><button key={opt} onClick={()=>setCurrent(opt)} style={{display:"block",width:"100%",background:current===opt?"rgba(79,70,229,0.2)":C.bg,border:`1px solid ${current===opt?C.accent:C.border}`,borderRadius:12,padding:"14px 16px",color:current===opt?"#a5b4fc":"#94a3b8",fontSize:15,cursor:"pointer",textAlign:"left",fontWeight:current===opt?700:400,marginBottom:8,minHeight:52}}>{opt}</button>)
          }
  ...
  return(
    <div style={{paddingBottom:80}}>
      ...
      {loading
        ?<div style={{textAlign:"center",padding:"48px 20px"}}><div style={{width:38,height:38,border:"3px solid #1e2130",borderTop:`3px solid ${C.accent}`,borderRadius:"50%",margin:"0 auto 14px",animation:"spin 1s linear infinite"}}/><div style={{color:C.muted,fontSize:14}}>{tx(lang,"analyzing")}</div></div>
        :<div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:16,padding:20}}>
          {renderText(result||"")}
          <button onClick={()=>{setStep(0);setAnswers({});setCurrent("");setResult(null);}} style={{marginTop:20,width:"100%",background:C.bg,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px",color:C.muted,fontSize:14,cursor:"pointer",minHeight:50}}>{tx(lang,"newAssessment")}</button>
        </div>
      }
    </div>
  );
...
function Onboarding({onComplete,lang,setLang}){
  ...
  const fields=[
    {key:"race",label:"How do you identify racially or ethnically?",labelEs:"¿Cómo te identificas racial o étnicamente?",icon:"🌍",options:RACES},
    {key:"gender",label:"How do you identify?",labelEs:"¿Cómo te identificas?",icon:"🧬",options:GENDERS},
    {key:"socioeconomic",label:"What best describes your economic background?",labelEs:"¿Qué describe mejor tu contexto económico?",icon:"💵",options:SOCIO},
    {key:"region",label:"What type of area do you live in?",labelEs:"¿En qué tipo de área vives?",icon:"📍",options:REGIONS},
  ];
  ...
  return(
    <div style={{background:C.bg,minHeight:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:20}}>
      <div style={{textAlign:"center",marginBottom:28}}>
        ...
        <h1 style={{color:C.text,fontSize:26,fontWeight:900,margin:0}}>LifeLens</h1>
        <p style={{color:"#64748b",fontSize:13,marginTop:6}}>{tx(lang,"appTagline")}</p>
        <div style={{display:"flex",gap:8,justifyContent:"center",marginTop:10}}>
          <button onClick={()=>setLang("en")} style={{background:lang==="en"?C.accent:"#1e2130",border:"none",borderRadius:20,padding:"6px 16px",color:"white",fontSize:13,fontWeight:lang==="en"?700:400,cursor:"pointer"}}>🇺🇸 EN</button>
          <button onClick={()=>setLang("es")} style={{background:lang==="es"?C.accent:"#1e2130",border:"none",borderRadius:20,padding:"6px 16px",color:"white",fontSize:13,fontWeight:lang==="es"?700:400,cursor:"pointer"}}>🇪🇸 ES</button>
        </div>
      </div>
      {step===0
        ?<div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:18,padding:26,maxWidth:400,width:"100%",textAlign:"center"}}>
          <p style={{color:"#94a3b8",fontSize:15,lineHeight:1.75,marginBottom:22}}>{tx(lang,"onboardingIntro")}</p>
          <div style={{color:C.muted,fontSize:13,marginBottom:22}}>{tx(lang,"questions4")}</div>
          <button onClick={()=>setStep(1)} style={{background:"linear-gradient(135deg,#4f46e5,#7c3aed)",border:"none",borderRadius:14,padding:"16px",width:"100%",color:"white",fontSize:16,fontWeight:700,cursor:"pointer",minHeight:52}}>{tx(lang,"getStarted")}</button>
          <div style={{marginTop:14,fontSize:12,color:"#374151"}}>{tx(lang,"onboardingPrivacy")}</div>
        </div>
        :<>
          <div style={{display:"flex",gap:8,marginBottom:22}}>
            {fields.map((_,i)=><div key={i} style={{width:9,height:9,borderRadius:5,background:i<step?C.accent:"#1e2130"}}/>)}
          </div>
          <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:18,padding:26,maxWidth:400,width:"100%"}}>
            ...
            {f.options.map(opt=><button key={opt} onClick={()=>pick(opt)} style={{display:"block",width:"100%",background:profile[f.key]===opt?"rgba(79,70,229,0.2)":C.bg,border:`1px solid ${profile[f.key]===opt?C.accent:C.border}`,borderRadius:12,padding:"14px 16px",color:profile[f.key]===opt?"#a5b4fc":"#94a3b8",fontSize:15,fontWeight:profile[f.key]===opt?700:400,cursor:"pointer",textAlign:"left",marginBottom:10,minHeight:52}}>{opt}</button>)}
          </div>
        </>
      }
    </div>
...
export default function LifeLens(){
  ...
  const[lang,setLang]=useState(()=>localStorage.getItem("lifelens_lang")||"en");

  window.__setLang = (l) => { setLang(l); try { localStorage.setItem("lifelens_lang", l); } catch {} };

  useEffect(()=>{
    try{const d=localStorage.getItem("lifelens_saved");if(d)setSaved(JSON.parse(d));}catch{}
  },[]);
  ...
  const handleSave=(id)=>{
    ...
    setSaved(updated);
    try{localStorage.setItem("lifelens_saved",JSON.stringify(updated));}catch{}
  };
  ...
  if(!unlocked) return (<PasswordGate onUnlock={unlock} lang={lang}/>);
  if(!profile) return (<Onboarding onComplete={setProfile} lang={lang} setLang={handleLang}/>);
  ...
  return(
    <div style={{background:C.bg,minHeight:"100%",color:C.text,fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>
      <div style={{background:C.card,borderBottom:`1px solid ${C.border}`,padding:"12px 16px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
        ...
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          <button onClick={()=>handleLang(lang==="en"?"es":"en")} style={{background:"#1e2130",border:`1px solid ${C.border}`,borderRadius:20,padding:"4px 12px",color:C.accentLight,fontSize:12,fontWeight:700,cursor:"pointer"}}>
            {lang==="en"?"🇪🇸 ES":"🇺🇸 EN"}
          </button>
          <button onClick={()=>setProfile(null)} style={{background:"none",border:`1px solid ${C.border}`,borderRadius:8,padding:"4px 10px",color:C.muted,fontSize:11,cursor:"pointer"}}>{tx(lang,"editProfile")}</button>
        </div>
      </div>
      <div style={{maxWidth:600,margin:"0 auto",padding:"16px 14px"}}>
        ...
        {tab==="journal"&&<JournalTab saved={saved} onUnsave={handleSave} lang={lang}/>}
      ...
      <style>{`html,body,#root{margin:0;padding:0;height:100%;}*{box-sizing:border-box;-webkit-tap-highlight-color:transparent;}textarea:focus,input:focus{border-color:#4f46e5!important;outline:none;}@keyframes spin{to{transform:rotate(360deg)}}::-webkit-scrollbar{display:none;}`}</style>
    </div>
  );
}
